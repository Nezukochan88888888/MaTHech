...
public class Page15Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Load MultipleChoiceforMultiplication.html
        webView.setWebViewClient(new WebViewClient());
        WebSettings webSettings = webView.getSettings();
        webSettings.setJavaScriptEnabled(true);
        webView.loadUrl("file:///android_asset/MultiplicationofIntegersIntroduction.html");
        ...
        btnNext.setOnClickListener(v -> {
            Intent intent = new Intent(Page15Activity.this, ReadyMultiplication.class);
            startActivity(intent);
        ...
        btnTableOfContents.setOnClickListener(v -> {
            Intent intent = new Intent(Page15Activity.this, TableOfContentsActivity.class);
            startActivity(intent);
        });
    }
}
