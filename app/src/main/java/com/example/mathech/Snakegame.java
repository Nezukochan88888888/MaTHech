...
public class Snakegame extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            String htmlContent = AESUtils.decryptFromAssets(this, "SnakeandIntegers.enc");
            if (htmlContent != null && !htmlContent.isEmpty()) {
                ...
                Log.e("Snakegame", "Decrypted HTML is empty or null");
            }
        } catch (Exception e) {
            Log.e("Snakegame", "Error loading SnakeandIntegers.enc", e);
        }
    }
