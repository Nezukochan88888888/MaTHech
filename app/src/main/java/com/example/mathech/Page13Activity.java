...
public class Page13Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.loadUrl("file:///android_asset/SubtractionMatchMePositive.html");

        // Back button: Page 12
        btnBack.setOnClickListener(v -> {
            Intent intent = new Intent(Page13Activity.this, Page12Activity.class);
        ...
        btnTableOfContents.setOnClickListener(v -> {
            Intent intent = new Intent(Page13Activity.this, TableOfContentsActivity.class);
            startActivity(intent);
        });
    }
}
