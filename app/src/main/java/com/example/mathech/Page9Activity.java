...
public class Page9Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Load SubtractingIntegersIntro.html
        webView.setWebViewClient(new WebViewClient());
        WebSettings webSettings = webView.getSettings();
        webSettings.setJavaScriptEnabled(true);
        webView.loadUrl("file:///android_asset/SubtractionMultipleChoice.html");
        ...
        btnTableOfContents.setOnClickListener(v -> {
            Intent intent = new Intent(Page9Activity.this, TableOfContentsActivity.class);
            startActivity(intent);
        });
    }
}
