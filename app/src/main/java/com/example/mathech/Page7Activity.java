...
public class Page7Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.loadUrl("file:///android_asset/AdditionMatchMeNegative.html");
        ...
        btnNext.setOnClickListener(v -> {
            Intent intent = new Intent(Page7Activity.this, Additionwordproblem.class);
            startActivity(intent);
        ...
        btnTableOfContents.setOnClickListener(v -> {
            Intent intent = new Intent(Page7Activity.this, TableOfContentsActivity.class);
            startActivity(intent);
        });
    }
}
