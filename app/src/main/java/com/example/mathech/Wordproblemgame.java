...
public class Wordproblemgame extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // ✅ Load encrypted WordproblemandIntegers HTML file
        try {
            String htmlContent = AESUtils.decryptFromAssets(this, "WordproblemandIntegers.enc");
            if (htmlContent != null && !htmlContent.isEmpty()) {
                ...
                Log.e("Wordproblemgame", "Decrypted HTML is empty or null");
            }
        } catch (Exception e) {
            Log.e("Wordproblemgame", "Error loading WordproblemandIntegers.enc", e);
        }
    }
