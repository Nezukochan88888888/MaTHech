...
public class Page18Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.loadUrl("file:///android_asset/MultiplicationDragIntegers.html");
        ...
        btnNext.setOnClickListener(v -> {
            Intent intent = new Intent(Page18Activity.this, Page19Activity.class);
            startActivity(intent);
        ...
        btnTableOfContents.setOnClickListener(v -> {
            Intent intent = new Intent(Page18Activity.this, TableOfContentsActivity.class);
            startActivity(intent);
        });
    }
}
